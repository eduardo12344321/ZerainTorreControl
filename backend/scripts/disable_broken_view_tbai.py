...
def disable_view_tbai():
    # ID found in previous step for res.config.settings
    view_id = 1789 
    name = "l10n_es_ticketbai_api.res_config_settings_view_form_inherit_l10n_es_ticketbai_api"
    
    print(f"🔧 Desactivando vista ID {view_id} ({name})...")
    try:
        ...
        print("🚀 Prueba ahora a abrir la configuración.")
